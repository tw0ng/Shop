...
NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	public void onNavigationDrawerItemSelected(int position) {
		...
		case 1:
			...
			break;
		case 2:
			fragmentManager.beginTransaction().replace(R.id.container, StringingServicesFragment.newInstance(position + 1)).commit();
			break;
		case 3:
		...
		case 4:
			...
			break;
		case 101:
			fragmentManager.beginTransaction().replace(R.id.container, RacketsFragment.newInstance(position + 1)).commit();
			break;
		case 102:
